...
namespace Homework6
{
    class OrderUI
    {
        ...
        public List<Order> Select()
        {
            ...
            Console.WriteLine("“0”按订单号查询，“1”按商品名查询，“2”按客户查询，“D”查询所有订单");
            ...
            switch (select)
            {
                case 'A':
                    Console.WriteLine("请输入订单号：");
                    orderListQuery = orderService.SelectOrder(0, Console.ReadLine());
                    break;
                    //orderListQuery = orderList.FindAll(o => o.orderNo == orderNumber); break;
                case 'B':
                    Console.WriteLine("请输入商品名：");
                    orderListQuery = orderService.SelectOrder(1, Console.ReadLine());
                    break;
                case 'C':
                    Console.WriteLine("请输入客户名：");
                    orderListQuery = orderService.SelectOrder(2, Console.ReadLine());
                    break;
